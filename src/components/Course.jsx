  ...
  return (
    <CourseCard>
      ...
      <div className='item-btns flex'>
        <Link to = {`/udemy-clone/courses/${id}`} className = "item-btn see-details-btn">See details</Link>
        <Link to = "/udemy-clone/cart" className='item-btn add-to-cart-btn' onClick={() => addToCart(id, image, course_name, creator, discounted_price, category)}>Add to cart</Link>
      </div>
